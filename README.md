...
Download the 3 files onto a controller device. The controller must have a pin connected to the the LEDs on the data wire. The following changes must be made to [main](main.py):
